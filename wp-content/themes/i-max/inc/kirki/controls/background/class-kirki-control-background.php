...
class Kirki_Control_Background extends WP_Customize_Control {
	...
	protected function l10n( $config_id ) {
		$translation_strings = array(
			'background-color'      => esc_attr__( 'Background Color', 'i-max' ),
			'background-image'      => esc_attr__( 'Background Image', 'i-max' ),
			'background-repeat'     => esc_attr__( 'Background Repeat', 'i-max' ),
			'background-attachment' => esc_attr__( 'Background Attachment', 'i-max' ),
			'background-position'   => esc_attr__( 'Background Position', 'i-max' ),
			'background-size'       => esc_attr__( 'Background Size', 'i-max' ),

			'no-repeat'             => esc_attr__( 'No Repeat', 'i-max' ),
			'repeat-all'            => esc_attr__( 'Repeat All', 'i-max' ),
			'repeat-x'              => esc_attr__( 'Repeat Horizontally', 'i-max' ),
			'repeat-y'              => esc_attr__( 'Repeat Vertically', 'i-max' ),

			'cover'                 => esc_attr__( 'Cover', 'i-max' ),
			'contain'               => esc_attr__( 'Contain', 'i-max' ),
			'auto'                  => esc_attr__( 'Auto', 'i-max' ),
			'inherit'               => esc_attr__( 'Inherit', 'i-max' ),

			'fixed'                 => esc_attr__( 'Fixed', 'i-max' ),
			'scroll'                => esc_attr__( 'Scroll', 'i-max' ),
			'local'                 => esc_attr__( 'Local', 'i-max' ),
			...
			'no-file-selected'      => esc_attr__( 'No File Selected', 'i-max' ),
			'remove'                => esc_attr__( 'Remove', 'i-max' ),
			'select-file'           => esc_attr__( 'Select File', 'i-max' ),
		);
