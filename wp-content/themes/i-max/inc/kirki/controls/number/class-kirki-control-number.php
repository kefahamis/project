...
class Kirki_Control_Number extends WP_Customize_Control {
	...
	protected function l10n() {
		$translation_strings = array(
			'min-error'  => esc_attr__( 'Value lower than allowed minimum', 'i-max' ),
			'max-error'  => esc_attr__( 'Value higher than allowed maximum', 'i-max' ),
			'step-error' => esc_attr__( 'Invalid Value', 'i-max' ),
		);
