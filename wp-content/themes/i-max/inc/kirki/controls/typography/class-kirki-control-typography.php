...
class Kirki_Control_Typography extends WP_Customize_Control {
	...
	protected function l10n( $config_id = false ) {
		$translation_strings = array(
			...
			'font-family'    => esc_attr__( 'Font Family', 'i-max' ),
			...
			'justify'        => esc_attr__( 'Justify', 'i-max' ),
			'color'          => esc_attr__( 'Color', 'i-max' ),
			'variant'        => esc_attr__( 'Variant', 'i-max' ),
			'subsets'        => esc_attr__( 'Subset', 'i-max' ),
			'text-align'     => esc_attr__( 'Text Align', 'i-max' ),
			'text-transform' => esc_attr__( 'Text Transform', 'i-max' ),
			'none'           => esc_attr__( 'None', 'i-max' ),
			'capitalize'     => esc_attr__( 'Capitalize', 'i-max' ),
			'uppercase'      => esc_attr__( 'Uppercase', 'i-max' ),
			'lowercase'      => esc_attr__( 'Lowercase', 'i-max' ),
			'initial'        => esc_attr__( 'Initial', 'i-max' ),
		);
