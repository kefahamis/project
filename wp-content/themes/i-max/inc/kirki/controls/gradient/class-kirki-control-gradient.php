...
class Kirki_Control_Gradient extends WP_Customize_Control {
	...
	protected function l10n() {
		$translation_strings = array(
			'angle'      => esc_attr__( 'Angle', 'i-max' ),
			'startcolor' => esc_attr__( 'Start Color', 'i-max' ),
			'endcolor'   => esc_attr__( 'End Color', 'i-max' ),
			'color_stop' => esc_attr__( 'Color Stop', 'i-max' ),
			'linear'     => esc_attr__( 'Linear', 'i-max' ),
			'radia'      => esc_attr__( 'Radial', 'i-max' ),
		);
