...
class Kirki_Modules_Search {
	...
	public function customize_controls_print_footer_scripts() {
		...
		$vars = array(
			...
			'button' => '<a class="kirki-customize-controls-search" href="#"><span class="screen-reader-text">' . esc_attr__( 'Search', 'i-max' ) . '</span></a>',
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control( 'kirki_search', array(
			'label'   => esc_attr__( 'Search Controls', 'i-max' ),
			'type'    => 'text',
